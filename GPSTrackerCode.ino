...
// WiFi credentials
const char* ssid = "AirOrangeX";      // WiFi SSID - Replace your own
const char* password = "";  // WiFi Password - Replace your own

// Server details for sending GPS data
const char* serverUrl = "https://www.circuitdigest.cloud/geolinker";  // Server URL
const char* apiKey = "4pUsAKtEXdU8";                                  //12 character API key for authentication
